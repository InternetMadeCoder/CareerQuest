        ...
        <div className="grid gap-[10rem] grid-cols-3 items-center">
            <div className="singleGrid rounded-[10px] hover:bg-[#fcfae3] p-[1.5rem]">
                <div className="flex items-center gap-3">
                    <div className="imgDiv p-[4px] rounded-[.8rem] bg-[#f3f2ad] bg-inherit-[#dedef8] h-[40px] w-[40px] flex items-center justify-center">
            ...
            <div className="singleGrid rounded-[10px] hover:bg-[#f7edf5] p-[1.5rem]">
                <div className="flex items-center gap-3">
                    <div className="imgDiv p-[4px] rounded-[.8rem] bg-[#dedef8] bg-inherit-[#dedef8] h-[40px] w-[40px] flex items-center justify-center">
            ...
            <div className="singleGrid rounded-[10px] hover:bg-[#fcf3ae] p-[1.5rem]">
                <div className="flex items-center gap-3">
                    <div className="imgDiv p-[4px] rounded-[.8rem] bg-[#f3f2ad] bg-inherit-[#dedef8] h-[40px] w-[40px] flex items-center justify-center">
